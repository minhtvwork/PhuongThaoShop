...
//        public List<PagingDto> GetAll(string search, decimal? from, decimal? to, string sortBy, int page)
...
//        public List<PagingDto> GetAllColor(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<PagingDto> GetAllScreen(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<PagingDto> GetAllRam(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//            }).ToList();
//        }
//        public List<PagingDto> GetAllHardDrive(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<PagingDto> GetAllCardVGA(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//            }).ToList();
//        }
//        public List<PagingDto> GetAllManufacturer(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<PagingDto> GetAllCpu(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
//            var allCpu = _context.CpuEntity.Where(x => x.TrangThai > 0).AsQueryable();
...
//            }).ToList();
//        }
//        public List<UserDto> GetAllUser(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<ProductDto> GetAllProduct(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<SerialDto> GetAllSerial(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
...
//        public List<VoucherEntity> GetAllVoucherPG(string? search, decimal? from, decimal? to, string? sortBy, int? page)
//        {
...
//            return allSerial.Select(hh => new VoucherEntity
//            {
//                Id = hh.Id,
...
//        public List<SanPhamGiamGiaDto> GetAllSPGGPGs(string? codeProductDetail, string? search, decimal? from, decimal? to, string? sortBy, int? page)
//        {
...
//        public List<GiamGiaEntity> GetAllGiamGia(string? search, decimal? from, decimal? to, string? sortBy, int page)
//        {
//            var allGiamGia = _context.GiamGias.Where(x => x.TrangThai > 0).AsQueryable();
//            int totalCount = allGiamGia.Count();
//            return allGiamGia.Select(hh => new GiamGiaEntity
//            {
//                Id = hh.Id,
//                Ma = hh.Ma,
//                Ten = hh.Ten,
