...
namespace PTS.EntityFrameworkCore.Repository
{
    public class ProductDetailRepository : IProductDetailRepository
    {
        ...
        //public async Task<IEnumerable<ProductDetailDto>> PGetProductDetail2(int? getNumber, string? codeProductDetail, int? status, string? search, decimal? from, decimal? to, string? sortBy, int page = 10)
        //{
